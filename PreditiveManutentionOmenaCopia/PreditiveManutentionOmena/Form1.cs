...
namespace PreditiveManutentionOmena
{
    public partial class Alert : Form
    {
        ...
        private void btnAnalise_Click(object sender, EventArgs e)
        {
            ...
            panel6.Visible = true;
            this.panel6.Controls.Clear();
            Analise frmInicio_Vrb = new Analise(tbAlertas.Text, tbTempr.Text) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            } else
            {
                try
                {
                    ...
                    ApagaMonitor.Start();
                    lbCorrente.Text = "0.75A";
                    lbPotencia.Text = "200W";
                } catch
                {
